  ...
  return (
    <>
      <section
        ...
        className="flex flex-row gap-3 overflow-x-auto md:overflow-x-hidden snap-x snap-mandatory pb-4 scrollbar-hide">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            data-card
...
export const FeedbackCard = ({
  ...
  return (
    <div className="gradient-blue border border-blue p-5 rounded-lg flex flex-col gap-10 h-full snap-start shrink-0 w-full md:shrink md:max-w-120 lg:max-w-130">
